...
const EditJobPage = ({updateJobSubmit}:any) => {
      ...
      <div className='container m-auto max-w-2xl py-24'>
        <div className='bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0'>
          <form onSubmit={submitForm}>
            <h2 className='text-3xl text-center font-semibold mb-6'>Edit / Update Job Listing</h2>
            ...
            <div className='mb-4'>
              ...
              <input 
                    type='text' id='title' name='title' className='border rounded w-full py-2 px-3 mb-2'
            ...
            <div className='mb-4'>
              ...
              <textarea 
                    id='description' name='description' className='border rounded w-full py-2 px-3'
            ...
            <div className='mb-4'>
              ...
              <select
                    id='salary' name='salary' className='border rounded w-full py-2 px-3' required
            ...
            <div className='mb-4'>
              ...
              <input 
                    type='text' id='location' name='location' className='border rounded w-full py-2 px-3 mb-2'
            ...
            <div className='mb-4'>
              ...
              <input
                    type='text' id='company' name='company' className='border rounded w-full py-2 px-3'
            ...
            <div className='mb-4'>
              ...
              <textarea
                    id='company_description' name='company_description' className='border rounded w-full py-2 px-3'
            ...
            <div className='mb-4'>
              ...
              <input 
                    ...
                    className='border rounded w-full py-2 px-3' placeholder='Email address for applicants'
                    required
            ...
            <div className='mb-4'>
              ...
              <input 
                    ...
                    className='border rounded w-full py-2 px-3' placeholder='Optional phone for applicants'
